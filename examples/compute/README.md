...
Полные `.tf`-конфигурации для всех ресурсов продукта **Виртуальные машины** - `cloudru_evolution_compute_*`, готовые к `terraform apply`.
...
Заполните валидные значения в файле `terraform.tfvars` - идентификатор проекта и ключ сервисного аккаунта.
